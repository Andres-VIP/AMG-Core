...
class UserControllerTest {
    ...
    void getAllUsers_shouldReturnListOfUsers() throws Exception {
        User user1 = new User("John Doe", "john@example.com", "123 Main St");
        user1.setId(1L);
        User user2 = new User("Jane Smith", "jane@example.com", "456 Oak Ave");
        user2.setId(2L);
    ...
    void createUser_whenEmailNotExists_shouldCreateUser() throws Exception {
        ...
        User savedUser = new User("John Doe", "john@example.com", "123 Main St");
        savedUser.setId(1L);
    ...
    void createUser_whenEmailExists_shouldReturn409() throws Exception {
        User newUser = new User("John Doe", "john@example.com", "123 Main St");
        User existingUser = new User("Existing User", "john@example.com", "Address");
    ...
    void updateUser_whenUserExists_shouldUpdateUser() throws Exception {
        User existingUser = new User("John Doe", "john@example.com", "123 Main St");
        existingUser.setId(1L);
        User updatedData = new User("John Updated", "john@example.com", "456 New St");
    ...
    void updateUser_whenEmailConflict_shouldReturn409() throws Exception {
        User existingUser = new User("John Doe", "john@example.com", "123 Main St");
        existingUser.setId(1L);
        User otherUser = new User("Other User", "other@example.com", "Address");
        otherUser.setId(2L);
        User updatedData = new User("John Updated", "other@example.com", "456 New St");
